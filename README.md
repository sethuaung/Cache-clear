# WindowsClearCache (Browser Cache/History/Temp ဖိုင်များကို ရှင်းလင်းရန်)
Scripts to clear temporary files and browser cache/history


## How To Run (အသုံးပြုနိုင်ပုံ)
...
** သတိပေးချက် **
(သင့် Computer စနစ်မှာ ဖြစ်ပျက်နိုင်တဲ့ အရာတွေအတွက် တာဝန်မယူပါဘူး!)
